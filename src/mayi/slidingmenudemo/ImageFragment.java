...
public class ImageFragment extends Fragment implements OnClickListener,OnTouchListener{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		// ‰ª?000Âº?ßãÊØèÈöî5000ÊâßË°åtimeTaks
...
//				if (lastY != scrollView.getScrollY())//Â∑¶Âè≥ÁßªÂä®‰∏çÂèòÔºå‰ΩÜÈ°µÈù¢Èú?¶Å
				{
	...
	public void onClick(View v) {
	    ...
	    new AlertDialog.Builder(this.getActivity()).setTitle("ƒÍ∆±∂©µ•").setView(layout)
	     .setPositiveButton("Ã·Ωª", null)
	...
	class ImageTimerTask extends TimerTask {
		...
		public void run() {
			...
			try {
				...
				Bundle date = new Bundle();// Â≠òÊîæÊï∞ÊçÆ
				date.putInt("pos", gallerypisition);
				msg.setData(date);
				msg.what = 1;// Ê∂àÊÅØÊ†áËØÜ
