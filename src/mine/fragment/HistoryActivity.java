...
public class HistoryActivity extends TestActivity {
	...
	// adapter.add(new HistoryItem(R.drawable.sight_img1, "ʪ�ع�԰", "AAAA",
	// "��ɽ�����Ŷ�����·", "160Ԫ"));
	// adapter.add(new HistoryItem(R.drawable.sight_img2, "ɭ�ֹ�԰", "AAAA",
	// "��ɽ�����Ŷ�����·", "160Ԫ"));
	...
	// // listView = (MyListView) findViewById(R.id.listview_history);
	// // adapter = new HistoryAdapter(this);
	// // adapter.add(new HistoryItem(0, "�ൺ��ɳ̲", "5��", "�ൺ�лƵ�����ɳ̲",
	// "100Ԫ"));
	// // adapter.add(new HistoryItem(0, "�ൺ��ɳ̲", "5��", "�ൺ�лƵ�����ɳ̲",
	// "100Ԫ"));
	// // listView.setAdapter(adapter);
