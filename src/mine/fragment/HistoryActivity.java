...
public class HistoryActivity extends TestActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		adapter.add(new HistoryItem(R.drawable.sight_img1, "湿地公园", "AAAA", "燕山立交桥二环东路", "160元"));
		adapter.add(new HistoryItem(R.drawable.sight_img2, "森林公园", "AAAA", "燕山立交桥二环东路", "160元"));
	...
	// listView = (MyListView) findViewById(R.id.listview_history);
	// adapter = new HistoryAdapter(this);
	// adapter.add(new HistoryItem(0, "青岛金沙滩", "5分", "青岛市黄岛区金沙滩", "100元"));
	// adapter.add(new HistoryItem(0, "青岛金沙滩", "5分", "青岛市黄岛区金沙滩", "100元"));
	// listView.setAdapter(adapter);
	//
	// }
	...
	// {
	// // TODO Auto-generated method stub
	// menu.add("清空").setShowAsAction(MenuItem.SHOW_AS_ACTION_ALWAYS);
