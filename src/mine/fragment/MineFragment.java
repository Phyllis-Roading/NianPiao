...
public class MineFragment extends Fragment implements OnClickListener {
	...
	private void initTableView() {
		// TODO Auto-generated method stub
		tableView.addBasicItem(R.drawable.mine_comment, "�ҵĶ���", null);
		tableView.addBasicItem(R.drawable.mine_favorite, "�ҵ��ղ�", null);
		tableView.addBasicItem(R.drawable.mine_browse_history, "�����ʷ", null);
		tableView.commit();
	}
